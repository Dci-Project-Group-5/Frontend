                    ...
                    <div className="member item">
                        ...
                        <div className="icon-link">
                            <a href="https://github.com/HuaHuaCamCam" target={'_blank'}>
                                ...
                                <p className="icon"><i className="fa-brands fa-github"></i></p>
                            </a>
                            <a href="https://github.com/HuaHuaCamCam" target={'_blank'}>
                                
                                <p className="icon"><i class="fa-brands fa-linkedin"></i></p>
                            </a>

                            <a href="https://github.com/HuaHuaCamCam" target={'_blank'}>
                                
                                <p className="icon"><i class="fa-brands fa-tiktok"></i></p>
                            </a>
